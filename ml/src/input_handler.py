...
# Import from sibling files — works both in src/ (development) and standalone (deployment)
try:
    from ensemble import ensemble_predict
    from gradcam import generate_gradcam, image_array_to_base64
except ImportError:
    from src.ensemble import ensemble_predict
    from src.gradcam import generate_gradcam, image_array_to_base64
